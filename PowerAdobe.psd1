@{
    ...
    FunctionsToExport      = @('Remove-AdobeGroupMember', 'Connect-Adobe', 'Get-AdobeCredentials', 'Get-AdobeGroup', 'Get-AdobeGroupMember', 'Get-AdobeUser', 'New-AdobeGroup', 'New-AdobeUser', 'Remove-AdobeGroup', 'Remove-AdobeUser', 'Set-AdobeGroup', 'Set-AdobeUser')
